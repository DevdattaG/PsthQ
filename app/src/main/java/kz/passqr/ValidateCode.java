...
/**
 * Created by KZ-Tech on 8/6/2016.
 */
public class ValidateCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.validate_codes);
    ...
    private class AsyncCallWS extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            Toast.makeText(ValidateCode.this, "Response" + resultString.toString(), Toast.LENGTH_LONG).show();
        }
    ...
    public void calculate() {
        ...
        try {
            ...
            Request.addProperty("CountryName", getCel);
